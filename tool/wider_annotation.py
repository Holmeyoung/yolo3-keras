...
val_bbx_file = 'wider_face/wider_face_val_bbx_gt.txt'
train_bbx_file = 'wider_face/wider_face_train_bbx_gt.txt'

val_data_folder = 'wider_face/WIDER_val'
train_data_folder = 'wider_face/WIDER_train'

out_file = 'WIDER_train.txt'
